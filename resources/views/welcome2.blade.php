...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/stle.css" rel="stylesheet">y
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                                    ...
                                    <h1 class="display-9 text-white mb-5 animated slideInRight">เปิดรับสมัครนักเรียน 12 ก.พ.-13 มี.ค.2567</h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="display-9 mb-4">ห้องเรียนปกติ ม.1 และ ม.4</h1>
                    ...
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            {{-- <p><i class="fa fa-check text-primary me-3"></i>ห้องเรียนพิเศษวิทย์-คณิต</p> --}}
                    ...
                    <p class="mb-4">1. ใบสมัครที่กรอกข้อมูลครบถ้วนสมบูรณ์ <br>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <h5 class="mb-0">officer@phanphit.ac.th  </h5>
                                </div>
                                <div class="ms-3">
    ...
    <div class="container">
        <div class="row justify-content-center p4">
            <div class="col-lg-3 text-start">
                <a href="{{ url('/takeclass') }}" class="center btn btn-primary py-3 px-5 animated">สมัครเรียน </a>
            </div>
        </div>   
    </div>
