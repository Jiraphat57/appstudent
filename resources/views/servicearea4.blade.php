...
<body>
    <br>
    <div class="container">
        <form class="row g-3" action="{{ route('servicearea4.update', $student->id) }}"
            ...
            <div class="row g-2 mb-2">
                    <div class="col-md-6 mb-2">
                        <div class="input-group mb-3">
                            ...
                            <select id="classlevel" name="classlevels_id"  class="form-select" aria-label="Default select example" disabled>
                                @foreach ($highschools as $curriculumsec)
                                    @if ($student->highschool1_id == $curriculumsec->id)
                                        <option selected>
                    ...
                    <div class="col-md-6 mb-2">
                        <select id="sel_servicearea" name="servicearea4_id" class="form-select @error('servicearea4_id') is-invalid @enderror"
                    ...
                    <div class="col-md-6 mb-2">
                        <select id="sel_districtschool4" name="districtschool4_id" class="form-select @error('districtschool4_id') is-invalid @enderror"
                            ...
                            <option value="4" {{ old('servicearea4_id', $student->districtschool4_id) == 4 ? 'selected' : '' }}>4 ต.สันติสุข</option>
                            <option value="5" {{ old('servicearea4_id', $student->districtschool4_id) == 5 ? 'selected' : '' }}>5 ต.ดอยงาม</option>
                            <option value="6" {{ old('servicearea4_id', $student->districtschool4_id) == 6 ? 'selected' : '' }}>6 ต.หัวง้ม</option>
                            <option value="7" {{ old('servicearea4_id', $student->districtschool4_id) == 7 ? 'selected' : '' }}>7 ต.เจริญเมือง</option>
                            <option value="8" {{ old('servicearea4_id', $student->districtschool4_id) == 8 ? 'selected' : '' }}>8 ต.ป่าหุ่ง</option>
                            <option value="9" {{ old('servicearea4_id', $student->districtschool4_id) == 9 ? 'selected' : '' }}>9 ต.ม่วงคำ</option>
                            <option value="10" {{ old('servicearea4_id', $student->districtschool4_id) == 10 ? 'selected' : '' }}>10 ต.ทรายขาว</option>
                            <option value="11" {{ old('servicearea4_id', $student->districtschool4_id) == 11 ? 'selected' : '' }}>11 ต.สันกลาง</option>
                            <option value="12" {{ old('servicearea4_id', $student->districtschool4_id) == 12 ? 'selected' : '' }}>12 ต.แม่เย็น</option>
                            <option value="13" {{ old('servicearea4_id', $student->districtschool4_id) == 13 ? 'selected' : '' }}>13 ต.เมืองพาน</option>
                            <option value="14" {{ old('servicearea4_id', $student->districtschool4_id) == 14 ? 'selected' : '' }}>14 ต.ทานตะวัน</option>
                            <option value="15" {{ old('servicearea4_id', $student->districtschool4_id) == 15 ? 'selected' : '' }}>15 ต.และเวียงห้าว</option>
                            <option value="16" {{ old('servicearea4_id', $student->districtschool4_id) == 16 ? 'selected' : '' }}>16 ต.ป่าแงะ อ.ป่าแดด</option>
                            <option value="17" {{ old('servicearea4_id', $student->districtschool4_id) == 17 ? 'selected' : '' }}>17 ต.ป่าแดด อ.ป่าแดด</option>
                            <option value="18" {{ old('servicearea4_id', $student->districtschool4_id) == 18 ? 'selected' : '' }}>18 ต.ป่าแฝก อ.แม่ใจ</option>
                            <option value="19" {{ old('servicearea4_id', $student->districtschool4_id) == 19 ? 'selected' : '' }}>19 อื่นๆ</option>

                        </select>
                        @error('districtschool4_id')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    </div>
                <div class="container ">
