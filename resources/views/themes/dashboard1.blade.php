...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box bg-primary">
                    <div class="inner text-center ">
                        <p style="font-family: 'THSarabun'; font-size: 36px; font-weight: bold;">นักเรียนระดับชั้น ม.1
                            ทั้งหมด(2569)</p>
                        <h1 style="font-family: 'THSarabun'; font-size: 70px; font-weight: bold;">
                            {{ number_format($countM1) }} คน</h1>
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-success">
                    <div class="inner text-center">
                        <p style="font-family: 'THSarabun'; font-size: 36px; font-weight: bold">นักเรียน ม.1
                            ในพื้นที่บริการ(2569)</p>
                        <h1 style="font-family: 'THSarabun'; font-size: 70px; font-weight: bold;">
                            {{ number_format($countInM1) }} คน</h1>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-3 col-6">
                <div class="small-box bg-warning">
                    <div class="inner">
                        <div class="inner text-center">
                            <p style="font-family: 'THSarabun'; font-size: 36px; font-weight: bold">นักเรียน ม.1
                                นอกพื้นที่บริการ(2569)</p>
                            <h1 style="font-family: 'THSarabun'; font-size: 70px; font-weight: bold;">
                                {{ number_format($countOutM1) }} คน</h1>
                        </div>
        ...
        <div class="row">
                ...
                <div class="card card-success">
                    <div class="card-header">
                        <h3 class="card-title" style="font-family: 'THSarabun'; font-size: 26px; font-weight: bold">
                            สรุปนักเรียนระดับชั้น ม.1 ทั้งหมด</h3>
            ...
            <div class="col-md-3">
                <a href="{{ route('exportM1.students') }}" class="btn btn-success btn-lg"
