...
<body>
    ...
    <div class="container px-10">
        ...
        <div class="row col-100%">
            ...
            <div style="font-size: 18px; border: 1px solid black;  padding: 20px;  margin: 20px;width: 90%;">1. ข้าพเจ้ามีส่วนรับผิดชอบต่อการกระทำของนักเรียน
        ...
        </div><div style="font-size: 18px; border: 1px solid black;  padding: 20px;  margin: 20px;width: 90%;"><div>
