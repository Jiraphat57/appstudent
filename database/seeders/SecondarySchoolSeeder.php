...
class SecondarySchoolSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // );
        $secondaryschools = [
            'ห้องเรียนพิเศษ(วิทยาศาสตร์-คณิตศาสตร์) ESMP', 'ห้องวิทยาศาสตร์พลังสิบ TPSP','ห้องเน้นความเป็นเลิศทางด้านเทคโนโลยีดิจิทัล  TEP ',
            ...
            'ห้องเน้นความเป็นเลิศทางด้านกีฬา SEP ','ห้องเรียนทั่วไป'
        ];
