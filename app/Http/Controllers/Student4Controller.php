...
class Student4Controller extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'phone4student' => 'required|min:10|max:10',
            ...
            'nationalid.max' => 'เลขบัตรประชาชนต้องมี 13 ตัว',
            ...
            'phone4student.min' => 'เบอร์โทรศัพท์นักเรียนต้องไม่ต่ำ 10 ตัว',
            'phone4student.max' => 'เบอร์โทรศัพท์นักเรียนต้องไม่เกิน 10 ตัว',
            ...
            'field_citizenfather.min' => 'เลขบัตรประชาชนบิดาต้องไม่ต่ำ 13 ตัว',
            'field_citizenfather.max' => 'เลขบัตรประชาชนบิดาต้องไม่เกิน 13 ตัว',
    ...
    public function update(Request $request, $id)
    {
        $validatedData = $request->validate([
            ...
            'nationalid.required' => 'กรุณากรอกเลขบัตรประชาชน',
            'nationalid.string' => 'เลขบัตรประชาชนต้องเป็นตัวอักษร',
            'nationalid.min' => 'เลขบัตรประชาชนต้องมี 13 ตัว',
            'nationalid.max' => 'เลขบัตรประชาชนต้องมี 13 ตัว',
            'religions_id.required' => 'กรุณาเลือกศาสนา',
            'religions_id.numeric' => 'ศาสนาต้องเป็นตัวเลข',
            'nationalities_id.required' => 'กรุณาเลือกสัญชาติ',
