...
class Student4 extends Model
{
    ...
    protected $fillable = ['classlevels_id','numId','typetitles_id','name','surname','nameeng','surnameeng','nationalid','phone4student','religions_id','nationalities_id','ethnicities_id','dateofbirth','provincesbirth_id','bloodtypes_id','travelschool1s_id','weight',
...
'highschool1_id','highschool2_id','highschool3_id','highschool4_id','highschool5_id','highschool6_id','highschool17_id','highschool8_id','highschool9_id','highschool10_id','servicearea4_id','districtschool4_id'];
    ...
    public function districtschools4(): BelongsTo
    {
        return $this->belongsTo(Districtschool::class, 'districtschool4_id', 'id');
    }
