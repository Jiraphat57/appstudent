...
class Students extends Model
{
    ...
    protected $fillable = ['classlevels_id','numId','typetitles_id','name','surname','nameeng','surnameeng','nationalid','phone1student','religions_id','nationalities_id','ethnicities_id','dateofbirth','provincesbirth_id','bloodtypes_id','travelschool1s_id','weight',
