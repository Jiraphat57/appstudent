...
class StudentsM1Export implements FromCollection, WithHeadings, WithMapping
{
    ...
    {
        return [
            'ชั้น','เลขที่สมัคร','คำนำหน้า','ชื่อ','นามสกุล','ชื่อภาษาอังกฤษ','นามสกุลภาษาอังกฤษ','เลขประจำตัวประชาชน','เบอร์โทร','ศาสนา','สัญชาติ','เชื้อชาติ','วันเกิด','จังหวัดเกิด','กรุ๊ปเลือด',
